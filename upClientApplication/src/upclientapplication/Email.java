...
public class Email {
    ...
    public void sendPassword(String studEmail, String studPassword) throws IOException {
        ...
        try {
            ...
            Message message = new MimeMessage(session);
            message.setFrom(new InternetAddress("s214212483@mandela.ac.za"));
            message.setRecipients(Message.RecipientType.TO, InternetAddress.parse(studEmail));
            message.setSubject("Password Recovery");
            message.setText("This is your password: " + studPassword);
